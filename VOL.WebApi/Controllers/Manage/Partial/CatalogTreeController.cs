...
namespace Org.Manage.Controllers
{
    public partial class CatalogTreeController
    {
        ...
        [AllowAnonymous]
        public virtual ActionResult<long> GetSerialNumber([FromBody] CatalogTree ct)
        {
        ...
        [AllowAnonymous]
        public virtual ActionResult<Catalog_Record> GetCode([FromBody] Submit date)
        {
        ...
        //IsSameTypeCode
        [HttpPost, Route("IsSameTypeCode")]
        [AllowAnonymous]
        public virtual ActionResult IsSameTypeCode([FromBody] CatalogTree catalogTree)
        {
            bool same = _service.IsSameTypeCode(catalogTree);
